...
namespace Common_library_development
{
    public static class PostGet
    {
        ...
        /// <param name="body">要传递的参数,格式"roleId=1&uid=2"</param>
        /// <param name="contentType">cotentType填写"application/x-www-form-urlencoded"soap填写:"text/xml; charset=utf-8"</param>
        /// <returns></returns>
